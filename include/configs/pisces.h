...
#define CONFIG_BOOTARGS		"mem=256M mem=256M@0x30000000 console=ttyS2,57600n8 ip=off root=/dev/mmcblk0p1 rw"
#else
#define CONFIG_BOOTARGS		"mem=512M console=ttyS2,57600n8 ip=off root=/dev/mmcblk0p1 rw"
#endif
...
#if defined(CONFIG_SDRAM_MDDR)
#define CONFIG_BOOTARGS		"mem=256M console=ttyS2,57600n8 ip=off root=/dev/mtdblock2 rw"
#else
...
/* #define CFG_MEMTEST_START	0x80100000 /\*0x00000000-0x80000000 */
/*                                              0xc0000000-0xf0000000 */
/*                                              virtual addr*\/ */
/* #define CFG_MEMTEST_END		0x8fe00000 */

#define CFG_MEMTEST_START	0x00000000 /*0x00000000-0x80000000
                                             0xc0000000-0xf0000000
                                             virtual addr*/
#define CFG_MEMTEST_END		0x0fffffff
...
#define PTN_USERDATA_SIZE           (20* 0x100000)
#define PTN_CACHE_SIZE              (20* 0x100000)	/* optional */
#define PTN_VFTME_SIZE              (0x800000000)//*512 because the mbr have some problem when the data overflow 32bit
/*======== Partition offset ============ */
...
#define PTN_VFTME_OFFSET               (PTN_CACHE_OFFSET+PTN_CACHE_SIZE)    
...
#else
#define MBR_P4_OFFSET 	PTN_VFTME_OFFSET
#define MBR_P4_SIZE 	PTN_VFTME_SIZE
#define MBR_P4_TYPE 	VFAT_FS_TYPE
#endif
